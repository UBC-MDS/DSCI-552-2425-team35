...
The data set used in creating our model was taken from 303 patients undergoing angiography Cleveland Clinic in Cleveland, Ohio [@heart_disease_45] (Janosi et al, 1989).
...
This includes:
1. Removing invalid target values (i.e. values above 
2) and converting the values to their semantic meaning.
...
to obtain an idea of possible correlations between features to be on the look out for
